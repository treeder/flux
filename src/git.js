...
export function createShadowWorktree(branchName, shadowPath) {
  ...
  console.log(`Creating shadow worktree: ${branchName} ${shadowPath}`)
...
export function createPullRequest(branchName, title, cwd = process.cwd()) {
  try {
    ...
    console.log(
      'Note: Could not automatically create PR. Ensure `gh` CLI is installed/authenticated and this repo has an `origin` remote.',
    )
  }
}

...
export async function createPullRequest(branchName, title, cwd = process.cwd(), issueNumber = null) {
  try {
    ...
    let body = `Automated PR generated by flux agentic VCS for intent: ${title}`
    if (issueNumber) {
      const isUrl = String(issueNumber).startsWith('http')
